		...
		// devices
			...
			var IBT0253D56843g = svg.append("g")
				...
				var IBT0253D56843IssuesG = IBT0253D56843g.append("g")
					...
					var issues = IBT0253D56843IssuesG.append("text")
						.text("Issues:")
						.attr("class", "text deviceElement")
						.attr("id", "deviceIssuesText")
						.attr("pointer-events", "none")
					...
					var IBT0253D56843Issue1g = IBT0253D56843IssuesG.append("g")
						...
						var issuesItem1 = IBT0253D56843Issue1g.append("text")
							.text("Inventoried?")
							.attr("class", "text deviceElement")
							.attr("pointer-events", "none")
							.attr("x", 422.03802)
						...
						var yesButton = IBT0253D56843Issue1g.append("rect")
							.attr("class", "yesButton deviceElement button")
							.attr("width", yesButtonD.width)
							.attr("height", yesButtonD.height)
							.attr("x", yesButtonD.x)
						...
						var noButton = IBT0253D56843Issue1g.append("rect")
							.attr("class", "noButton deviceElement button")
							.attr("width", noButtonD.width)
							.attr("height", noButtonD.height)
							.attr("x", noButtonD.x)
						...
						var yesY = IBT0253D56843Issue1g.append("text")
							.text("Y")
							.attr("class", "text deviceElement")
							.attr("x", 900.37415)
							.attr("y", 510.35)
						...
						var noN = IBT0253D56843Issue1g.append("text")
							.text("N")
							.attr("class", "text deviceElement")
							.attr("x", 996.8728)
							.attr("y", 509.66257)
			...
			var ILB0221Dxxxxxg = svg.append("g")
				...
				var ILB0221DxxxxxIssuesG = ILB0221Dxxxxxg.append("g")
					.attr("id", "ILB0221DxxxxxIssuesG");

					var issues = ILB0221DxxxxxIssuesG.append("text")
						.text("Issues:")
						.attr("class", "text deviceElement")
						.attr("id", "deviceIssuesText")
						.attr("pointer-events", "none")
					...
					var ILB0221DxxxxxIssue1g = ILB0221DxxxxxIssuesG.append("g")
						.attr("id", "ILB0221DxxxxxIssue1g");

						var issuesItem1 = ILB0221DxxxxxIssue1g.append("text")
							.text("Inventoried?")
							.attr("class", "text deviceElement")
							.attr("pointer-events", "none")
							.attr("x", 422.03802)
						...
						var yesButton = ILB0221DxxxxxIssue1g.append("rect")
							.attr("class", "yesButton deviceElement button")
							.attr("width", yesButtonD.width)
							.attr("height", yesButtonD.height)
							.attr("x", yesButtonD.x)
							...
							.on("click", function(){
								d3.select(this)
									.style("opacity", 1)
									.classed("chosenButton", true)
								d3.select("#ILB0221DxxxxxIssue1g").select(".noButton")
									.style("opacity", 0)
									.classed("chosenButton", false);
							});

						var noButton = ILB0221DxxxxxIssue1g.append("rect")
							.attr("class", "noButton deviceElement button")
							.attr("width", noButtonD.width)
							.attr("height", noButtonD.height)
							.attr("x", noButtonD.x)
							...
							.on("click", function(){
								d3.select(this)
									.style("opacity", 1)
									.classed("chosenButton", true)
								d3.select("#ILB0221DxxxxxIssue1g").select(".yesButton")
									.style("opacity", 0)
									.classed("chosenButton", false);
							});

						var yesY = ILB0221DxxxxxIssue1g.append("text")
							.text("Y")
							.attr("class", "text deviceElement")
							.attr("x", 900.37415)
							.attr("y", 510.35)
						...
						var noN = ILB0221DxxxxxIssue1g.append("text")
							.text("N")
							.attr("class", "text deviceElement")
							.attr("x", 996.8728)
							.attr("y", 509.66257)
