...
var svg = d3.select("body").append("svg")
	...
	var svg2 = svg.append("g").attr("transform", "scale(0.7)");

	// Campus Map
	var CampusMap = svg2.append("g")
		.attr("id", "CampusMap")
	...
	// devices
	var IBT0253D56843g = svg2.append("g")
